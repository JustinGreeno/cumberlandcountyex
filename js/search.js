...
const searchIndex = [
    ...
    { type: "page", icon: "🐴", title: "Hobby Horse Competition", desc: "Build your own hobby horse Saturday morning, ride it in the arena Saturday afternoon — free, spaces limited", url: "hobby-horse.html", keywords: "hobby horse competition show workshop page kids children stick horse make build craft dining hall arena saturday september 5 information details entry register" },
    ...
    { type: "form", icon: "🐴", title: "Hobby Horse Competition Registration", desc: "Register for the Hobby Horse Competition — Saturday, Sept 5 · No charge · Spaces are limited", url: "hobby-horse.html#register", keywords: "hobby horse competition show registration register sign up google form kids children free no charge spaces limited register in advance adult accompanied ages 3 back number saturday september 5 2026 kirsteen thomson" },
    ...
    { type: 'form', icon: '🎉', title: 'Parade Entry Form (printable)', desc: 'Print the paper parade entry form — no entry fee. Email it in or drop it at the CCEx office.', url: 'images/forms and documents/parade form.jpg', keywords: 'parade entry form printable print paper download hard copy pdf jpg picture sheet email drop off office no entry fee free name phone email entry description theme sew it grow it show it september 5 2026' },
    { type: 'form', icon: '📣', title: 'Join the Parade — Info Sheet', desc: 'The parade flyer — line up 12:45 PM on Foundry St, parade starts 1:00 PM, and how to sign up.', url: 'images/forms and documents/parade info how to join.jpg', keywords: 'parade information info sheet flyer poster how to join sign up take part line up lineup 12:45 foundry street oxford floats decorated vehicles walking groups community organizations clubs families businesses saturday september 5 2026' },
    ...
    { type: 'form', icon: '📄', title: 'Horse Pull Rules 2026', desc: 'Official rules for the Heavy Horse Pull competition', url: 'images/forms and documents/horse pulls rules 2026.pdf', keywords: 'horse pull pulls rules regulations 2026 heavy draft horse competition pdf weight classes' },
    ...
    { type: "event", icon: "🐴", title: "Hobby Horse Competition", desc: "Saturday, Sept 5 — riders build a hobby horse at 10 AM in the dining hall and show it in the arena at 3 PM.", url: "hobby-horse.html", keywords: "hobby horse competition show workshop kids children stick horse make build craft dining hall arena 10 am 3 pm saturday september 5 free english western riding clothes cowboy hats back number take home" },
    ...
    { type: 'info', icon: '🗺️', title: 'Parade Route Map', desc: 'Line up 12:45 PM on Foundry St · quiet zone Waverly to Main · judges at Main & Duke · ends back on Water St by the grounds', url: 'parade.html#route', keywords: 'parade route map oxford foundry street water street main street duke street ellis prince william station waverly bridge black river line up lineup 12:45 what time start finish end judges quiet zone where does the parade go directions turn' },
