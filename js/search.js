...
const searchIndex = [
    ...
    // Forms
    { type: 'form', icon: '📄', title: "Kids Show 'N Shine Registration", desc: "Register your child's car or vehicle — 9 years and under · Free · Entries closed Aug 15, 2026", url: 'show-n-shine.html#register', keywords: 'show shine kids car vehicle registration children 9 under junior entry register free pre-register pre registration deadline closing date august 15 2026' },
    ...
    { type: 'info', icon: '📅', title: 'Junior Beef Show Deadline', desc: 'Entries & $25 fee were due August 10, 2026 — no late entries', url: 'junior-beef-show.html', keywords: 'junior beef show deadline entry due august 10 2026 registration registry fee 25 no late entries t-shirt payable cumberland junior beef show' },
    ...
    { type: 'info', icon: '🚗', title: "Kids Show 'N Shine Deadline", desc: 'Registration closed August 15, 2026 — pre-registration was required', url: 'show-n-shine.html#register', keywords: "show n shine kids deadline registration closes closing date august 15 2026 pre-register pre registration required free children 9 under vehicle car" },
