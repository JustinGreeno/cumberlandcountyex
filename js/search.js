...
const searchIndex = [
    ...
    { type: 'event', icon: '🐂', title: 'Junior Beef Show', desc: 'Runs throughout the weekend — separate entry form required', url: 'beef-registration.html', keywords: 'junior beef show youth weekend separate entry form sunday' },
