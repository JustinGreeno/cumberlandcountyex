...
const searchIndex = [
    ...
    { type: 'page', icon: '🎄', title: 'Christmas Tree Competition', desc: 'In memory of Keith Moore of ShelBell Farm — details and online entry', url: 'christmas-tree.html', keywords: 'christmas tree competition page xmas evergreen fir spruce grower woodlot keith moore shelbell farm memorial information details entry' },
    ...
    { type: 'form', icon: '🎄', title: 'Christmas Tree Competition Entry', desc: 'Enter the CCEx Christmas Tree Competition — $5 per entry, up to 10 trees. In memory of Keith Moore.', url: 'christmas-tree.html#registration', keywords: 'christmas tree competition entry registration register sign up form jotform xmas evergreen fir spruce balsam grower woodlot keith moore shelbell farm memorial 5 dollars five per entry 2026' },
    ...
    { type: 'form', icon: '📄', title: 'Baking & Pickling Entry 2026', desc: 'Home crafts — baking and preserves (Classes 3-17)', url: 'images/forms and documents/3-17 baking-pickling 2026-1.pdf', keywords: 'baking pickling preserves home crafts classes 2026 3 17' },
    { type: 'form', icon: '📄', title: 'Arts & Crafts Entry 2026', desc: 'Handmade arts and crafts (Classes 18-26)', url: 'images/forms and documents/arts and crafts 2026- 1.pdf', keywords: 'arts crafts handmade classes 2026 18 26' },
    { type: 'form', icon: '📄', title: 'Flowers Entry 2026', desc: 'Floral entries and arrangements (Classes 27-33)', url: 'images/forms and documents/flowers 2026-1.pdf', keywords: 'flowers floral arrangements classes 2026 27 33' },
    { type: 'form', icon: '📄', title: 'Children Competition Entry 2026', desc: 'Youth exhibitor competition (Class 34)', url: 'images/forms and documents/Children\'s competition 2026-1.pdf', keywords: 'children kids competition youth class 2026 34' },
    ...
    { type: 'event', icon: '🎄', title: 'Christmas Tree Competition', desc: 'A festive tree competition in memory of Keith Moore of ShelBell Farm — $5 per entry', url: 'christmas-tree.html', keywords: 'christmas tree competition keith moore shelbell farm memorial festive xmas evergreen fir spruce balsam grower woodlot judging display' },
    ...
    { type: 'info', icon: '📅', title: 'Beef Show Entry Deadline', desc: 'Entries close July 31, 2026', url: 'beef-registration.html', keywords: 'beef show entry deadline close july 31 2026 register early last day' },
    ...
    { type: 'info', icon: '📅', title: 'Junior Beef Show Deadline', desc: 'Entries & $25 fee due August 10, 2026 — no late entries', url: 'junior-beef-show.html', keywords: 'junior beef show deadline entry due august 10 2026 registration registry fee 25 no late entries t-shirt payable cumberland junior beef show' },
